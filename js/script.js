...
var wipeAnimation = new TimelineMax()
    //.fromTo(".section--pos", 1, {x:  "-100%"}, {x: "0%", backgroundColor: "#d62828", ease: Linear.easeNone});
    .fromTo(".section--pos", 1, {x:  "-100%"}, {x: "0%", backgroundColor: "#d62828", ease: Linear.easeNone});
...
// var changeImgTeen = TweenMax.to(obj, 1,
//     {
...
//         onUpdate: function () {
//             $("#testimonial__img--model").attr("src", images[obj.curImg]); // set the image source
//         }
//     }
// );

// new ScrollMagic.Scene({triggerElement: "#testimonial--model", duration: 300})
//     .setTween(changeImgTeen)
//     .addTo(controller);
